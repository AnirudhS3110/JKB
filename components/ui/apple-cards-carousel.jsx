    ...
    >
      <div className="relative w-full">
        ...
        >
          ...
          <div
            className={cn(
              "flex flex-row justify-start gap-2 md:gap-4 pl-4",
...
export const Card = ({
  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 top-0 md:top-0 z-[230] h-screen overflow-auto pt-16 md:pt-20">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <motion.div
              ...
              className="relative z-[230] mx-auto mt-20 h-fit max-w-5xl rounded-3xl bg-white p-4 font-sans md:p-10 dark:bg-neutral-900"
            >
              <button
                suppressHydrationWarning
      ...
      <motion.button
        ...
        whileHover={{ 
          ...
          className="relative z-10 flex h-64 w-44 flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 md:h-[28rem] md:w-96 dark:bg-neutral-900 cursor-pointer"
      >
