...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[300vh] z-[210] py-40 md:py-0 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-[#000000] from-[#F8D4B9] to-[#F9A778]"
