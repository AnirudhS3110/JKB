              ...
              <div className="grid grid-cols-1  gap-16 mb-16">
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-paragraph lg:text-[18px] xl:text-[20px]">These partnerships are ideal for organizations with resources to contribute to sustainable infrastructure development</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-paragraph lg:text-[18px] xl:text-[20px]">Our infrastructure partnerships focus on sustainable development that creates lasting community impact</p>
                    </div>
                  </div>
                </motion.div>
              </div>
