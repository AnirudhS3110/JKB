              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-16">
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-paragraph">These partnerships are ideal for organizations with communication expertise and a passion for social storytelling</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-paragraph">Our media partnerships prioritize authentic storytelling and targeted messaging for maximum impact</p>
                    </div>
                  </div>
                </motion.div>
              </div>
