...
export default function VolunteerCapacityPartnership() {
  ...
  const partnershipData = {
    ...
    tagline: "Mobilizing skills for social transformation",
    who: "Corporates, skill development organizations, individual volunteers",
    description: "Our Volunteer & Capacity-Building partnerships bring together skilled individuals and organizations to strengthen communities and grassroots initiatives. Through skill-sharing, training, and volunteer programs, we build sustainable capacity for long-term social impact.",
    howToPartner: [
      "Contribute skills or expertise through structured volunteer programs",
      "Conduct training and development programs for community organizations",
      "Support capacity building for local changemakers and grassroots initiatives"
    ],
    image: "/images/partnership/volunteer-capacity.jpg",
    icon: (
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-20 text-white w-full">
            ...
            >
              ...
              <p className="text-xl font-paragraph text-gray-200 max-w-2xl">
                {partnershipData.tagline}. Partner with us to build capacity and strengthen communities.
              </p>
            </motion.div>
          </div>
          ...
          >
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="grid grid-cols-1  gap-16 mb-16">
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-paragraph lg:text-[18px] xl:text-[20px]">These partnerships are ideal for organizations and individuals who want to contribute skills and time for meaningful social impact</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-paragraph lg:text-[18px] xl:text-[20px]">Our volunteer programs are structured to maximize impact while providing meaningful engagement opportunities</p>
                    </div>
                  </div>
                </motion.div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                  <div className="relative h-64 md:h-auto">
                    <Image 
                      ...
                      alt="Volunteer collaboration" 
                      fill
                      className="object-cover"
                    />
                  </div>
                  <div className="p-8">
                    <h3 className="text-2xl font-heading font-light text-gray-800 mb-3">Capacity-Building in Action</h3>
                    <p className="text-gray-700 font-paragraph mb-6">
                      Our volunteer partnerships have strengthened community organizations and equipped local leaders with new skills. Through targeted training and skill-sharing programs, we've helped build sustainable capacity in areas ranging from digital literacy to community organizing.
                    </p>
                    <p className="text-gray-700 font-paragraph">
                      By focusing on knowledge transfer and empowerment, our volunteer engagements create lasting change that extends beyond the initial program.
                    </p>
                  </div>
                </div>
              </motion.div> */}
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-3xl font-heading font-light mb-4">Ready to Share Your Skills?</h3>
