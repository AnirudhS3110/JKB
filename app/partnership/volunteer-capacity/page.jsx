              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-16">
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-paragraph">These partnerships are ideal for organizations and individuals who want to contribute skills and time for meaningful social impact</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-paragraph">Our volunteer partnerships emphasize structured engagement for sustainable impact and skill transfer</p>
                    </div>
                  </div>
                </motion.div>
              </div>
