              ...
              <div className="grid grid-cols-1  gap-16 mb-16">
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-paragraph lg:text-[18px] xl:text-[20px]">These partnerships are ideal for government bodies and civic organizations looking to amplify their social impact</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 font-paragraph lg:text-[18px] xl:text-[20px]">Our government and civic partnerships focus on collaborative approaches to address complex social challenges</p>
                    </div>
                  </div>
                </motion.div>
              </div>
