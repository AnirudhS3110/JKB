...
export default function PartnershipTypesSection() {
  ...
  const partnershipTypes = [
    ...
    },
    {
      ...
      quote: "Join forces with us to craft compelling narratives, raise awareness, and mobilize support for critical social causes. Our media partnerships create powerful storytelling that inspires action and drives meaningful engagement.",
    ...
    },
    {
      ...
      quote: "Empower your team through meaningful volunteer opportunities and capacity building initiatives. Our partnerships create pathways for skill-based volunteering, leadership development, and community engagement that benefit all stakeholders.",
    ...
    },
    {
      ...
      quote: "Work with us to bridge public and private sectors for systemic change. Our government partnerships facilitate policy advocacy, program implementation, and resource mobilization that address structural challenges at scale.",
    ...
    },
    {
      ...
      quote: "Partner with us to strengthen the physical and organizational infrastructure needed for lasting social impact. From facility development to systems strengthening, these collaborations create the foundation for sustainable community development.",
      src: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
  ...
  return (
    <section id="partnership-types" className="bg-[#fbfbfb] " ref={sectionRef}>
      <div className="max-w-7xl lg:max-w-[1000px] mx-auto px-6">
        ...
        >
          <h2 className="text-4xl font-heading font-light text-black mb-6">Partnership Types</h2>
