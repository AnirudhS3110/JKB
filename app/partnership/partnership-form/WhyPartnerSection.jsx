...
export default function WhyPartnerSection() {
  ...
  const reasons = [
    ...
    },
    {
      ...
      description: "Access our team's specialized knowledge in sustainable development, community engagement, and social innovation. We bring proven methodologies and creative problem-solving approaches to every partnership, helping you pioneer solutions that truly make a difference.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-[#F4720B]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Align your brand with authentic social responsibility. Our partnerships are built on transparency and measurable outcomes, helping you demonstrate genuine commitment to societal improvement while building trust with your stakeholders and customers.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-[#F4720B]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
